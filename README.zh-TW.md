<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/slicenferqin/xuanpu/releases/latest"><img src="https://img.shields.io/github/v/release/slicenferqin/xuanpu?style=flat-square&logo=github&label=version" alt="最新版本" /></a>
    <a href="https://github.com/slicenferqin/xuanpu/releases"><img src="https://img.shields.io/github/downloads/slicenferqin/xuanpu/total?style=flat-square&logo=github" alt="下載次數" /></a>
    <a href="https://github.com/slicenferqin/xuanpu/actions/workflows/release.yml"><img src="https://img.shields.io/github/actions/workflow/status/slicenferqin/xuanpu/release.yml?style=flat-square&logo=github-actions&label=build" alt="建置狀態" /></a>
    ...
    <a href="https://github.com/slicenferqin/xuanpu/pulls"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen?style=flat-square" alt="歡迎 PR" /></a>
  </p>
</div>
...
- [什麼是 Xuanpu？](#什麼是-xuanpu)
- [功能](#功能)
- [為什麼選擇 Xuanpu？](#為什麼選擇-xuanpu)
- [安裝](#安裝)
- [快速開始](#快速開始)
- [連接 — 革命性功能](#-連接---革命性功能)
- [截圖](#截圖)
...
Xuanpu 是一個 AI 代理協調器。在一個側邊欄中看到所有正在執行的代理，點擊切換，每個代理都在隔離的 git worktree 分支上運行，因此不會發生衝突。連接多個儲存庫，讓單一代理工作階段擁有整個技術棧的上下文。
...
### 🤖 **內建 AI 編碼工作階段**
在 Xuanpu 中直接執行 AI 編碼代理，支援 **OpenCode** 和 **Claude Code**。即時串流回應、觀察工具呼叫執行、按需核准權限。完整的復原/重做支援讓你始終掌握控制權。
...
從 [GitHub Releases](https://github.com/slicenferqin/xuanpu/releases/latest) 下載最新的 `.dmg`。

就是這樣！從「應用程式」資料夾開啟 Xuanpu，指向一個 git 儲存庫即可。
...
### 1️⃣ **新增你的第一個專案**
開啟 Xuanpu → 點擊 **「Add Project」** → 選擇電腦上的任何 git 儲存庫
...
Xuanpu 的 **Worktree 連接**功能讓你將兩個 worktree 連結在一起，在不同的分支或功能之間建立橋樑。對於需要跨分支感知的開發工作流程來說極為強大。
...
- ✅ **智慧建議** - Xuanpu 根據你的工作流程建議相關的 worktree 進行連接
...
<div align="center">
  <img src="docs/screenshots/hive-full-demo.gif" alt="Xuanpu 展示 — 跨專案協調 AI 代理" width="900" />
</div>
...
<div align="center">
  <br/>
  <img src="docs/screenshots/hive-ss-1.png" alt="Xuanpu — AI 編碼工作階段與 git worktree" width="900" />
  <sub>AI 驅動的編碼工作階段，整合 git worktree 管理</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-worktree-create.png" alt="建立新的 worktree" width="900" />
  <sub>視覺化建立和管理 worktree</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-file-tree.png" alt="帶 git 狀態的檔案樹" width="900" />
  <sub>帶有即時 git 狀態指示器的檔案總管</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-themes.png" alt="主題展示" width="900" />
  <sub>適合各種偏好的精美主題</sub>
</div>
...
[![Issues](https://img.shields.io/badge/🐛_Issues-回報-red?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/issues)
[![討論](https://img.shields.io/badge/💬_討論-加入-purple?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/discussions)
...
- 📖 閱讀[文件](docs/)取得詳細指南
- 🐛 附帶重現步驟[回報錯誤](https://github.com/slicenferqin/xuanpu/issues/new?template=bug_report.md)
- 💡 [請求功能](https://github.com/slicenferqin/xuanpu/issues/new?template=feature_request.md)你想要的功能
- 💬 [加入討論](https://github.com/slicenferqin/xuanpu/discussions)與社群交流
...
想影響路線圖？[加入討論](https://github.com/slicenferqin/xuanpu/discussions/categories/ideas)或[貢獻](CONTRIBUTING.md)！
...
Xuanpu 包含一個選用的原生終端機，由 [Ghostty](https://ghostty.org/) 的 `libghostty` 驅動。僅在需要開發內嵌終端機功能時才需要。
...
如果 `libghostty` 不可用，Xuanpu 仍然可以建置和執行 — Ghostty 終端機功能只是會被停用。
...
Xuanpu 使用 Electron 的三程序模型搭配嚴格沙箱：
...
我們歡迎貢獻！Xuanpu 由開發者為開發者打造，我們歡迎各種改進。
...
Xuanpu 是根據 MIT 授權的開源軟體。完整詳情請參閱 [LICENSE](LICENSE) 檔案。
