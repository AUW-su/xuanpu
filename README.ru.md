<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/slicenferqin/xuanpu/releases/latest"><img src="https://img.shields.io/github/v/release/slicenferqin/xuanpu?style=flat-square&logo=github&label=version" alt="Последний релиз" /></a>
    <a href="https://github.com/slicenferqin/xuanpu/releases"><img src="https://img.shields.io/github/downloads/slicenferqin/xuanpu/total?style=flat-square&logo=github" alt="Загрузки" /></a>
    <a href="https://github.com/slicenferqin/xuanpu/actions/workflows/release.yml"><img src="https://img.shields.io/github/actions/workflow/status/slicenferqin/xuanpu/release.yml?style=flat-square&logo=github-actions&label=build" alt="Статус сборки" /></a>
    ...
    <a href="https://github.com/slicenferqin/xuanpu/pulls"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen?style=flat-square" alt="PR приветствуются" /></a>
  </p>
</div>
...
- [Что такое Xuanpu?](#что-такое-xuanpu)
- [Возможности](#возможности)
- [Почему Xuanpu?](#почему-xuanpu)
- [Установка](#установка)
...
Xuanpu — это оркестратор ИИ-агентов. Все запущенные агенты видны в одной боковой панели, переключение между ними одним кликом, и каждый работает в изолированной ветке git worktree, поэтому конфликты исключены. Подключайте несколько репозиториев, чтобы одна сессия агента имела контекст всего вашего стека.
...
Запускайте ИИ-агентов для кодирования прямо внутри Xuanpu с поддержкой **OpenCode** и **Claude Code**. Стримьте ответы в реальном времени, наблюдайте за вызовами инструментов и одобряйте разрешения по мере необходимости. Полная поддержка отмены/повтора даёт вам контроль.
...
Посмотрите, как Xuanpu преображает ваш git-workflow:

| Задача | Традиционный workflow | С Xuanpu |
|------|---------------------|-----------|
...
Скачайте последний `.dmg` с [GitHub Releases](https://github.com/slicenferqin/xuanpu/releases/latest).

Вот и всё! Откройте Xuanpu из папки «Программы» и укажите на git-репозиторий.
...
Откройте Xuanpu → Нажмите **«Add Project»** → Выберите любой git-репозиторий на вашем компьютере
...
Функция **Соединений Worktree** в Xuanpu позволяет связать два worktree, создавая мост между разными ветками или функциями. Невероятно мощный инструмент для workflow, требующих межветочного осознания.
...
- ✅ **Умные предложения** - Xuanpu предлагает релевантные worktree для соединения на основе вашего workflow
...
<div align="center">
  <img src="docs/screenshots/hive-full-demo.gif" alt="Демо Xuanpu — оркестрация ИИ-агентов между проектами" width="900" />
</div>
...
<div align="center">
  <br/>
  <img src="docs/screenshots/hive-ss-1.png" alt="Xuanpu — ИИ-сессия кодирования с git worktree" width="900" />
  <sub>ИИ-сессии кодирования с интегрированным управлением git worktree</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-worktree-create.png" alt="Создание нового worktree" width="900" />
  <sub>Визуальное создание и управление worktree</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-file-tree.png" alt="Дерево файлов со статусом git" width="900" />
  <sub>Файловый менеджер с индикаторами статуса git в реальном времени</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-themes.png" alt="Витрина тем" width="900" />
...
[![Issues](https://img.shields.io/badge/🐛_Issues-Сообщить-red?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/issues)
[![Обсуждения](https://img.shields.io/badge/💬_Обсуждения-Присоединиться-purple?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/discussions)
...
- 🐛 [Сообщайте об ошибках](https://github.com/slicenferqin/xuanpu/issues/new?template=bug_report.md) с шагами воспроизведения
- 💡 [Запрашивайте функции](https://github.com/slicenferqin/xuanpu/issues/new?template=feature_request.md), которые хотели бы видеть
- 💬 [Присоединяйтесь к обсуждениям](https://github.com/slicenferqin/xuanpu/discussions) для связи с сообществом
...
- **Система плагинов** — Расширяйте Xuanpu собственными интеграциями
...
Хотите повлиять на дорожную карту? [Присоединяйтесь к обсуждению](https://github.com/slicenferqin/xuanpu/discussions/categories/ideas) или [внесите вклад](CONTRIBUTING.md)!
...
Xuanpu включает опциональный нативный терминал на основе `libghostty` от [Ghostty](https://ghostty.org/). Требуется только для работы над встроенной функцией терминала.
...
Если `libghostty` недоступен, Xuanpu всё равно собирается и запускается — функция терминала Ghostty просто будет отключена.
...
Xuanpu использует трёхпроцессную модель Electron со строгой песочницей:
...
Мы рады вкладам! Xuanpu создан разработчиками для разработчиков, и мы приветствуем улучшения любого рода.
...
Xuanpu — это программное обеспечение с открытым исходным кодом, лицензированное по лицензии MIT. Подробности в файле [LICENSE](LICENSE).
