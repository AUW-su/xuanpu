...
- [Xuanpu คืออะไร?](#xuanpu-คืออะไร)
- [ฟีเจอร์](#ฟีเจอร์)
- [ทำไมต้อง Xuanpu?](#ทำไมต้อง-xuanpu)
...
Xuanpu เป็นตัวจัดการ AI agent ดู agent ที่กำลังทำงานทั้งหมดในแถบด้านข้างเดียว คลิกเพื่อสลับระหว่างพวกมัน และแต่ละตัวทำงานบนแบรนช์ git worktree ที่แยกอิสระจึงไม่ขัดกัน เชื่อมต่อ repository หลายตัวเข้าด้วยกันเพื่อให้ agent session เดียวมี context ครอบคลุมทั้ง stack ของคุณ
...
รัน AI coding agent โดยตรงใน Xuanpu พร้อมรองรับทั้ง **OpenCode** และ **Claude Code** สตรีมการตอบกลับแบบเรียลไทม์ ดู tool call ทำงาน และอนุมัติสิทธิ์ตามต้องการ รองรับ undo/redo เต็มรูปแบบเพื่อให้คุณควบคุมได้ตลอด
...
ดูว่า Xuanpu เปลี่ยนเวิร์กโฟลว์ git ของคุณอย่างไร:

| งาน | เวิร์กโฟลว์แบบดั้งเดิม | กับ Xuanpu |
|------|---------------------|-----------|
...
ดาวน์โหลดไฟล์ `.dmg` ล่าสุดจาก [GitHub Releases](https://github.com/slicenferqin/xuanpu/releases/latest)

แค่นั้น! เปิด Xuanpu จากโฟลเดอร์ Applications แล้วชี้ไปที่ git repo
...
เปิด Xuanpu → คลิก **"เพิ่มโปรเจกต์"** → เลือก git repository ใดก็ได้บนเครื่องของคุณ
...
ฟีเจอร์ **การเชื่อมต่อ Worktree** ของ Xuanpu ให้คุณเชื่อมโยง worktree สองตัวเข้าด้วยกัน สร้างสะพานระหว่างแบรนช์หรือฟีเจอร์ต่างๆ นี่มีพลังอย่างไม่น่าเชื่อสำหรับเวิร์กโฟลว์การพัฒนาที่ต้องการการรับรู้ข้ามแบรนช์
...
- ✅ **การแนะนำอัจฉริยะ** - Xuanpu แนะนำ worktree ที่เกี่ยวข้องเพื่อเชื่อมต่อตามเวิร์กโฟลว์ของคุณ
...
## ดู Xuanpu ในการใช้งานจริง

<div align="center">
  <img src="docs/screenshots/hive-full-demo.gif" alt="สาธิต Xuanpu — จัดการ AI agent ข้ามโปรเจกต์" width="900" />
</div>
...
<div align="center">
  <br/>
  <img src="docs/screenshots/hive-ss-1.png" alt="Xuanpu — เซสชันเขียนโค้ด AI กับ git worktree" width="900" />
  <sub>เซสชันเขียนโค้ด AI พร้อมการจัดการ git worktree แบบบูรณาการ</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-worktree-create.png" alt="สร้าง worktree ใหม่" width="900" />
  <sub>สร้างและจัดการ worktree แบบวิชวล</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-file-tree.png" alt="ทรีไฟล์พร้อมสถานะ git" width="900" />
  <sub>ตัวสำรวจไฟล์พร้อมตัวบ่งชี้สถานะ git แบบสด</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-themes.png" alt="โชว์เคสธีม" width="900" />
...
[![Issues](https://img.shields.io/badge/🐛_ปัญหา-รายงาน-red?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/issues)
[![Discussions](https://img.shields.io/badge/💬_สนทนา-เข้าร่วม-purple?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/discussions)
...
- 🐛 [รายงานบัก](https://github.com/slicenferqin/xuanpu/issues/new?template=bug_report.md) พร้อมขั้นตอนการทำซ้ำ
- 💡 [ขอฟีเจอร์](https://github.com/slicenferqin/xuanpu/issues/new?template=feature_request.md) ที่คุณอยากเห็น
- 💬 [เข้าร่วมการสนทนา](https://github.com/slicenferqin/xuanpu/discussions) เพื่อเชื่อมต่อกับชุมชน
...
- **ระบบปลั๊กอิน** — ขยาย Xuanpu ด้วยการผสานแบบกำหนดเอง
...
อยากมีอิทธิพลต่อแผนงาน? [เข้าร่วมการสนทนา](https://github.com/slicenferqin/xuanpu/discussions/categories/ideas) หรือ [มีส่วนร่วม](CONTRIBUTING.md)!
...
Xuanpu มีเทอร์มินัล native แบบตัวเลือกที่ขับเคลื่อนด้วย `libghostty` ของ [Ghostty](https://ghostty.org/) จำเป็นเฉพาะเมื่อคุณต้องการทำงานกับฟีเจอร์เทอร์มินัลแบบฝัง
...
หาก `libghostty` ไม่พร้อมใช้งาน Xuanpu ยังคง build และรันได้ -- ฟีเจอร์เทอร์มินัล Ghostty จะถูกปิดใช้งาน
...
Xuanpu ใช้โมเดลสามโปรเซสของ Electron พร้อม sandboxing ที่เข้มงวด:
...
เรารักการมีส่วนร่วม! Xuanpu สร้างโดยนักพัฒนา เพื่อนักพัฒนา และเรายินดีต้อนรับการปรับปรุงทุกประเภท
...
Xuanpu เป็นซอฟต์แวร์โอเพนซอร์สที่อนุญาตภายใต้สัญญาอนุญาต MIT ดูไฟล์ [LICENSE](LICENSE) สำหรับรายละเอียดทั้งหมด
