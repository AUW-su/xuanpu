<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/slicenferqin/xuanpu/releases/latest"><img src="https://img.shields.io/github/v/release/slicenferqin/xuanpu?style=flat-square&logo=github&label=version" alt="Останній реліз" /></a>
    <a href="https://github.com/slicenferqin/xuanpu/releases"><img src="https://img.shields.io/github/downloads/slicenferqin/xuanpu/total?style=flat-square&logo=github" alt="Завантаження" /></a>
    <a href="https://github.com/slicenferqin/xuanpu/actions/workflows/release.yml"><img src="https://img.shields.io/github/actions/workflow/status/slicenferqin/xuanpu/release.yml?style=flat-square&logo=github-actions&label=build" alt="Статус збірки" /></a>
    ...
    <a href="https://github.com/slicenferqin/xuanpu/pulls"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen?style=flat-square" alt="PR вітаються" /></a>
  </p>
</div>
...
- [Що таке Xuanpu?](#що-таке-xuanpu)
- [Можливості](#можливості)
- [Чому Xuanpu?](#чому-xuanpu)
...
Xuanpu — це оркестратор AI-агентів. Бачите всіх запущених агентів в одній бічній панелі, клацаєте для перемикання між ними, і кожен працює в ізольованій гілці git worktree, тому вони не можуть конфліктувати. Підключайте кілька репозиторіїв, щоб одна сесія агента мала контекст усього вашого стеку.
...
Запускайте AI-агентів для кодування прямо в Xuanpu з підтримкою **OpenCode** та **Claude Code**. Стрімте відповіді в реальному часі, спостерігайте за викликами інструментів та затверджуйте дозволи за потреби. Повна підтримка скасування/повтору тримає вас під контролем.
...
Подивіться, як Xuanpu перетворює ваш git-workflow:

| Завдання | Традиційний workflow | З Xuanpu |
|------|---------------------|-----------|
...
Завантажте останній `.dmg` з [GitHub Releases](https://github.com/slicenferqin/xuanpu/releases/latest).

Ось і все! Відкрийте Xuanpu з папки «Програми» та вкажіть на git-репозиторій.
...
Відкрийте Xuanpu → Натисніть **«Add Project»** → Оберіть будь-який git-репозиторій на вашому комп'ютері
...
Функція **З'єднань Worktree** в Xuanpu дозволяє зв'язати два worktree, створюючи міст між різними гілками або функціями. Неймовірно потужний інструмент для workflow, що потребують міжгілкової обізнаності.
...
- ✅ **Розумні пропозиції** - Xuanpu пропонує релевантні worktree для з'єднання на основі вашого workflow
...
<div align="center">
  <img src="docs/screenshots/hive-full-demo.gif" alt="Демо Xuanpu — оркестрація AI-агентів між проєктами" width="900" />
</div>
...
<div align="center">
  <br/>
  <img src="docs/screenshots/hive-ss-1.png" alt="Xuanpu — AI-сесія кодування з git worktree" width="900" />
  <sub>AI-сесії кодування з інтегрованим керуванням git worktree</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-worktree-create.png" alt="Створення нового worktree" width="900" />
  <sub>Візуальне створення та керування worktree</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-file-tree.png" alt="Дерево файлів зі статусом git" width="900" />
  <sub>Файловий менеджер з індикаторами статусу git в реальному часі</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-themes.png" alt="Вітрина тем" width="900" />
...
[![Issues](https://img.shields.io/badge/🐛_Issues-Повідомити-red?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/issues)
[![Обговорення](https://img.shields.io/badge/💬_Обговорення-Приєднатися-purple?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/discussions)
...
- 🐛 [Повідомляйте про помилки](https://github.com/slicenferqin/xuanpu/issues/new?template=bug_report.md) з кроками відтворення
- 💡 [Запитуйте функції](https://github.com/slicenferqin/xuanpu/issues/new?template=feature_request.md), які хотіли б бачити
- 💬 [Приєднуйтесь до обговорень](https://github.com/slicenferqin/xuanpu/discussions) для зв'язку зі спільнотою
...
- **Система плагінів** — Розширюйте Xuanpu власними інтеграціями
...
Хочете вплинути на дорожню карту? [Приєднуйтесь до обговорення](https://github.com/slicenferqin/xuanpu/discussions/categories/ideas) або [зробіть внесок](CONTRIBUTING.md)!
...
Xuanpu включає опціональний нативний термінал на основі `libghostty` від [Ghostty](https://ghostty.org/). Потрібен лише для роботи над вбудованою функцією терміналу.
...
Якщо `libghostty` недоступний, Xuanpu все одно збирається та запускається — функція терміналу Ghostty просто буде вимкнена.
...
Xuanpu використовує трипроцесну модель Electron зі суворою пісочницею:
...
Ми раді внескам! Xuanpu створений розробниками для розробників, і ми вітаємо покращення будь-якого роду.
...
Xuanpu — це програмне забезпечення з відкритим кодом, ліцензоване за ліцензією MIT. Повні деталі у файлі [LICENSE](LICENSE).
