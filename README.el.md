...
- [Τι είναι το Xuanpu;](#τι-είναι-το-xuanpu)
- [Χαρακτηριστικά](#χαρακτηριστικά)
- [Γιατί Xuanpu;](#γιατί-xuanpu)
...
Το Xuanpu είναι ένας ενορχηστρωτής AI agent. Δείτε όλους τους τρέχοντες agents σε μία πλαϊνή μπάρα, κάντε κλικ για εναλλαγή μεταξύ τους, και ο καθένας εκτελείται σε ένα απομονωμένο git worktree branch ώστε να μην μπορούν να συγκρουστούν. Συνδέστε πολλαπλά repositories μαζί ώστε μία μόνο agent session να έχει context σε ολόκληρο το stack σας.
...
Εκτελέστε AI coding agents απευθείας μέσα στο Xuanpu με υποστήριξη τόσο για **OpenCode** όσο και για **Claude Code**. Παρακολουθήστε απαντήσεις σε πραγματικό χρόνο, δείτε tool calls να εκτελούνται, και εγκρίνετε δικαιώματα όπως χρειάζεται. Πλήρης υποστήριξη undo/redo σας κρατά στον έλεγχο.
...
Δείτε πώς το Xuanpu μεταμορφώνει τη ροή εργασίας σας στο git:

| Εργασία | Παραδοσιακή ροή εργασίας | Με το Xuanpu |
|------|---------------------|-----------|
...
Κατεβάστε το τελευταίο `.dmg` από τα [GitHub Releases](https://github.com/slicenferqin/xuanpu/releases/latest).

Αυτό ήταν! Ανοίξτε το Xuanpu από τον φάκελο Εφαρμογών και κατευθύνετέ το σε ένα git repo.
...
Ανοίξτε το Xuanpu → Κλικ **"Προσθήκη Έργου"** → Επιλέξτε οποιοδήποτε git repository στον υπολογιστή σας
...
Η λειτουργία **Συνδέσεων Worktree** του Xuanpu σας επιτρέπει να συνδέσετε δύο worktrees μαζί, δημιουργώντας μια γέφυρα μεταξύ διαφορετικών branches ή features. Αυτό είναι απίστευτα ισχυρό για ροές ανάπτυξης που απαιτούν επίγνωση μεταξύ branches.
...
- ✅ **Έξυπνες προτάσεις** - Το Xuanpu προτείνει σχετικά worktrees για σύνδεση βάσει της ροής εργασίας σας
...
<div align="center">
  <img src="docs/screenshots/hive-full-demo.gif" alt="Demo Xuanpu — ενορχηστρώστε AI agents σε πολλαπλά έργα" width="900" />
</div>
...
<div align="center">
  <br/>
  <img src="docs/screenshots/hive-ss-1.png" alt="Xuanpu — AI coding συνεδρία με git worktrees" width="900" />
  <sub>AI coding συνεδρίες με ενσωματωμένη διαχείριση git worktree</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-worktree-create.png" alt="Δημιουργία νέου worktree" width="900" />
  <sub>Δημιουργήστε και διαχειριστείτε worktrees οπτικά</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-file-tree.png" alt="Δέντρο αρχείων με git status" width="900" />
  <sub>Εξερευνητής αρχείων με ζωντανούς δείκτες κατάστασης git</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-themes.png" alt="Επίδειξη θεμάτων" width="900" />
...
[![Issues](https://img.shields.io/badge/🐛_Ζητήματα-Αναφέρετε-red?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/issues)
[![Discussions](https://img.shields.io/badge/💬_Συζητήσεις-Συμμετέχετε-purple?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/discussions)
...
- 🐛 [Αναφέρετε σφάλματα](https://github.com/slicenferqin/xuanpu/issues/new?template=bug_report.md) με βήματα αναπαραγωγής
- 💡 [Ζητήστε χαρακτηριστικά](https://github.com/slicenferqin/xuanpu/issues/new?template=feature_request.md) που θα θέλατε να δείτε
- 💬 [Συμμετέχετε στις συζητήσεις](https://github.com/slicenferqin/xuanpu/discussions) για σύνδεση με την κοινότητα
...
- **Σύστημα plugins** — Επεκτείνετε το Xuanpu με προσαρμοσμένες ενσωματώσεις
...
Θέλετε να επηρεάσετε τον οδικό χάρτη; [Συμμετέχετε στη συζήτηση](https://github.com/slicenferqin/xuanpu/discussions/categories/ideas) ή [συνεισφέρετε](CONTRIBUTING.md)!
...
Το Xuanpu περιλαμβάνει ένα προαιρετικό native τερματικό που τροφοδοτείται από το `libghostty` του [Ghostty](https://ghostty.org/). Χρειάζεται μόνο αν θέλετε να εργαστείτε στη λειτουργία ενσωματωμένου τερματικού.
...
Αν το `libghostty` δεν είναι διαθέσιμο, το Xuanpu εξακολουθεί να κάνει build και να εκτελείται -- η λειτουργία τερματικού Ghostty απλώς θα είναι απενεργοποιημένη.
...
Το Xuanpu χρησιμοποιεί το μοντέλο τριών διεργασιών του Electron με αυστηρό sandboxing:
...
Αγαπάμε τις συνεισφορές! Το Xuanpu είναι φτιαγμένο από developers, για developers, και καλωσορίζουμε βελτιώσεις κάθε είδους.
...
Το Xuanpu είναι λογισμικό ανοιχτού κώδικα αδειοδοτημένο υπό την Άδεια MIT. Δείτε το αρχείο [LICENSE](LICENSE) για πλήρεις λεπτομέρειες.
