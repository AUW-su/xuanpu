...
Xuanpu একটি AI এজেন্ট অর্কেস্ট্রেটর। আপনার সব চলমান এজেন্ট একটি সাইডবারে দেখুন, তাদের মধ্যে সুইচ করতে ক্লিক করুন, এবং প্রতিটি একটি বিচ্ছিন্ন git worktree ব্রাঞ্চে চলে তাই তারা সংঘাত করতে পারে না। একাধিক রিপোজিটরি একসাথে সংযুক্ত করুন যাতে একটি একক এজেন্ট সেশনের আপনার পুরো স্ট্যাক জুড়ে কনটেক্সট থাকে।
...
**OpenCode** এবং **Claude Code** উভয় সাপোর্ট সহ সরাসরি Xuanpu-এর ভেতরে AI কোডিং এজেন্ট চালান। রিয়েল-টাইমে রেসপন্স স্ট্রিম করুন, tool call এক্সিকিউট হতে দেখুন, এবং প্রয়োজন অনুযায়ী পারমিশন অনুমোদন করুন। সম্পূর্ণ undo/redo সাপোর্ট আপনাকে নিয়ন্ত্রণে রাখে।
...
দেখুন কিভাবে Xuanpu আপনার git ওয়ার্কফ্লো রূপান্তরিত করে:

| কাজ | ঐতিহ্যগত ওয়ার্কফ্লো | Xuanpu-এর সাথে |
|------|---------------------|-----------|
...
[GitHub Releases](https://github.com/slicenferqin/xuanpu/releases/latest) থেকে সর্বশেষ `.dmg` ডাউনলোড করুন।

ব্যস! Applications ফোল্ডার থেকে Xuanpu খুলুন এবং একটি git repo-তে পয়েন্ট করুন।
...
Xuanpu খুলুন → **"প্রজেক্ট যোগ করুন"** ক্লিক → আপনার মেশিনে যেকোনো git repository নির্বাচন করুন
...
Xuanpu-এর **Worktree সংযোগ** ফিচার আপনাকে দুটি worktree একসাথে লিংক করতে দেয়, বিভিন্ন ব্রাঞ্চ বা ফিচারের মধ্যে একটি সেতু তৈরি করে। ক্রস-ব্রাঞ্চ সচেতনতার প্রয়োজন এমন ডেভেলপমেন্ট ওয়ার্কফ্লোর জন্য এটি অবিশ্বাস্যভাবে শক্তিশালী।
...
- ✅ **স্মার্ট সাজেশন** - Xuanpu আপনার ওয়ার্কফ্লোর ভিত্তিতে সংযোগ করার জন্য প্রাসঙ্গিক worktree সাজেস্ট করে
...
## Xuanpu দেখুন কর্মরত অবস্থায়

<div align="center">
  <img src="docs/screenshots/hive-full-demo.gif" alt="Xuanpu ডেমো — প্রজেক্ট জুড়ে AI এজেন্ট অর্কেস্ট্রেট করুন" width="900" />
</div>
...
<div align="center">
  <br/>
  <img src="docs/screenshots/hive-ss-1.png" alt="Xuanpu — git worktree সহ AI কোডিং সেশন" width="900" />
  <sub>ইন্টিগ্রেটেড git worktree ম্যানেজমেন্ট সহ AI-চালিত কোডিং সেশন</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-worktree-create.png" alt="নতুন worktree তৈরি" width="900" />
  <sub>ভিজ্যুয়ালি worktree তৈরি এবং পরিচালনা করুন</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-file-tree.png" alt="git স্ট্যাটাস সহ ফাইল ট্রি" width="900" />
  <sub>লাইভ git স্ট্যাটাস ইন্ডিকেটর সহ ফাইল এক্সপ্লোরার</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-themes.png" alt="থিম শোকেস" width="900" />
...
[![Issues](https://img.shields.io/badge/🐛_সমস্যা-রিপোর্ট-red?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/issues)
[![Discussions](https://img.shields.io/badge/💬_আলোচনা-যোগদান-purple?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/discussions)
...
- 🐛 পুনরুত্পাদন ধাপ সহ [বাগ রিপোর্ট করুন](https://github.com/slicenferqin/xuanpu/issues/new?template=bug_report.md)
- 💡 আপনি যা দেখতে চান এমন [ফিচার অনুরোধ করুন](https://github.com/slicenferqin/xuanpu/issues/new?template=feature_request.md)
- 💬 কমিউনিটির সাথে সংযুক্ত হতে [আলোচনায় যোগ দিন](https://github.com/slicenferqin/xuanpu/discussions)
...
- **প্লাগইন সিস্টেম** — কাস্টম ইন্টিগ্রেশন দিয়ে Xuanpu প্রসারিত করুন
...
রোডম্যাপে প্রভাব রাখতে চান? [আলোচনায় যোগ দিন](https://github.com/slicenferqin/xuanpu/discussions/categories/ideas) বা [অবদান রাখুন](CONTRIBUTING.md)!
...
Xuanpu [Ghostty](https://ghostty.org/)-এর `libghostty` দ্বারা চালিত একটি ঐচ্ছিক নেটিভ টার্মিনাল অন্তর্ভুক্ত করে। এটি শুধুমাত্র তখন প্রয়োজন যদি আপনি এমবেডেড টার্মিনাল ফিচারে কাজ করতে চান।
...
যদি `libghostty` পাওয়া না যায়, Xuanpu এখনও বিল্ড এবং রান হবে -- Ghostty টার্মিনাল ফিচার শুধু নিষ্ক্রিয় থাকবে।
...
Xuanpu কঠোর স্যান্ডবক্সিং সহ Electron-এর তিন-প্রসেস মডেল ব্যবহার করে:
...
আমরা অবদান পছন্দ করি! Xuanpu ডেভেলপারদের দ্বারা, ডেভেলপারদের জন্য তৈরি, এবং আমরা সব ধরনের উন্নতি স্বাগত জানাই।
...
Xuanpu MIT লাইসেন্সের অধীনে লাইসেন্সকৃত ওপেন সোর্স সফটওয়্যার। সম্পূর্ণ বিবরণের জন্য [LICENSE](LICENSE) ফাইল দেখুন।
