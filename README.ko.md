<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/slicenferqin/xuanpu/releases/latest"><img src="https://img.shields.io/github/v/release/slicenferqin/xuanpu?style=flat-square&logo=github&label=version" alt="최신 릴리스" /></a>
    <a href="https://github.com/slicenferqin/xuanpu/releases"><img src="https://img.shields.io/github/downloads/slicenferqin/xuanpu/total?style=flat-square&logo=github" alt="다운로드" /></a>
    <a href="https://github.com/slicenferqin/xuanpu/actions/workflows/release.yml"><img src="https://img.shields.io/github/actions/workflow/status/slicenferqin/xuanpu/release.yml?style=flat-square&logo=github-actions&label=build" alt="빌드 상태" /></a>
    ...
    <a href="https://github.com/slicenferqin/xuanpu/pulls"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen?style=flat-square" alt="PR 환영" /></a>
  </p>
</div>
...
Xuanpu는 AI 에이전트 오케스트레이터입니다. 실행 중인 모든 에이전트를 하나의 사이드바에서 확인하고, 클릭으로 전환하며, 각 에이전트는 격리된 git worktree 브랜치에서 실행되어 충돌할 수 없습니다. 여러 리포지토리를 연결하여 하나의 에이전트 세션이 전체 스택의 컨텍스트를 가질 수 있습니다.
...
### 🤖 **내장 AI 코딩 세션**
**OpenCode**와 **Claude Code**를 모두 지원하여 Xuanpu 내에서 직접 AI 코딩 에이전트를 실행. 실시간으로 응답을 스트리밍하고, 도구 호출 실행을 관찰하며, 필요에 따라 권한을 승인. 완전한 undo/redo 지원으로 항상 제어할 수 있습니다.
...
Xuanpu가 git 워크플로우를 어떻게 변화시키는지 확인하세요:

| 작업 | 기존 워크플로우 | Xuanpu 사용 시 |
|------|---------------------|-----------|
...
최신 `.dmg`를 [GitHub Releases](https://github.com/slicenferqin/xuanpu/releases/latest)에서 다운로드하세요.

끝입니다! 응용 프로그램 폴더에서 Xuanpu를 열고 git 리포지토리를 지정하세요.
...
### 1️⃣ **첫 번째 프로젝트 추가**
Xuanpu 열기 → **"Add Project"** 클릭 → 컴퓨터의 아무 git 리포지토리 선택
...
Xuanpu의 **Worktree 커넥션** 기능은 두 Worktree를 연결하여 서로 다른 브랜치나 기능 사이에 브리지를 만듭니다. 크로스 브랜치 인식이 필요한 개발 워크플로우에 매우 강력합니다.
...
<div align="center">
  <img src="docs/screenshots/hive-full-demo.gif" alt="Xuanpu 데모 — 프로젝트 전반의 AI 에이전트 오케스트레이션" width="900" />
</div>
...
<div align="center">
  <br/>
  <img src="docs/screenshots/hive-ss-1.png" alt="Xuanpu — git worktree와 AI 코딩 세션" width="900" />
  <sub>통합 git worktree 관리가 포함된 AI 기반 코딩 세션</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-worktree-create.png" alt="새 Worktree 생성" width="900" />
  <sub>Worktree를 시각적으로 생성 및 관리</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-file-tree.png" alt="git 상태가 있는 파일 트리" width="900" />
  <sub>라이브 git 상태 표시기가 있는 파일 탐색기</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-themes.png" alt="테마 쇼케이스" width="900" />
...
[![Issues](https://img.shields.io/badge/🐛_Issues-보고하기-red?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/issues)
[![Discussions](https://img.shields.io/badge/💬_Discussions-참여하기-purple?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/discussions)
...
- 🐛 재현 단계와 함께 [버그 보고](https://github.com/slicenferqin/xuanpu/issues/new?template=bug_report.md)
- 💡 보고 싶은 [기능 요청](https://github.com/slicenferqin/xuanpu/issues/new?template=feature_request.md)
- 💬 [Discussions 참여](https://github.com/slicenferqin/xuanpu/discussions)로 커뮤니티와 연결
...
로드맵에 영향을 주고 싶으신가요? [토론에 참여](https://github.com/slicenferqin/xuanpu/discussions/categories/ideas)하거나 [기여](CONTRIBUTING.md)하세요!
...
Xuanpu에는 [Ghostty](https://ghostty.org/)의 `libghostty`를 사용한 선택적 네이티브 터미널이 포함되어 있습니다. 내장 터미널 기능을 작업하려는 경우에만 필요합니다.
...
`libghostty`를 사용할 수 없어도 Xuanpu는 정상적으로 빌드되고 실행됩니다 — Ghostty 터미널 기능만 비활성화됩니다.
...
Xuanpu는 엄격한 샌드박싱을 갖춘 Electron의 3프로세스 모델을 사용합니다:
...
기여를 환영합니다! Xuanpu는 개발자에 의해, 개발자를 위해 만들어졌으며, 모든 종류의 개선을 환영합니다.
...
Xuanpu는 MIT 라이선스 하에 배포되는 오픈소스 소프트웨어입니다. 자세한 내용은 [LICENSE](LICENSE) 파일을 참조하세요.
