...
- [ما هو Xuanpu؟](#ما-هو-xuanpu)
- [الميزات](#الميزات)
- [لماذا Xuanpu؟](#لماذا-xuanpu)
- [التثبيت](#التثبيت)
...
Xuanpu هو منسّق وكلاء ذكاء اصطناعي. شاهد جميع وكلائك العاملين في شريط جانبي واحد، انقر للتبديل بينهم، وكل واحد يعمل على فرع worktree معزول في git حتى لا يتعارضوا. اربط عدة مستودعات معاً ليكون لجلسة وكيل واحدة سياق عبر مجموعتك التقنية بالكامل.
...
شغّل وكلاء برمجة بالذكاء الاصطناعي مباشرة داخل Xuanpu مع دعم كل من **OpenCode** و**Claude Code**. تابع الردود في الوقت الفعلي، راقب تنفيذ استدعاءات الأدوات، ووافق على الأذونات حسب الحاجة. دعم كامل للتراجع والإعادة يبقيك متحكماً.
...
شاهد كيف يحوّل Xuanpu سير عمل git الخاص بك:

| المهمة | سير العمل التقليدي | مع Xuanpu |
|------|---------------------|-----------|
...
حمّل أحدث ملف `.dmg` من [إصدارات GitHub](https://github.com/slicenferqin/xuanpu/releases/latest).

هذا كل شيء! افتح Xuanpu من مجلد التطبيقات ووجّهه إلى مستودع git.
...
افتح Xuanpu → انقر **"إضافة مشروع"** → اختر أي مستودع git على جهازك
...
ميزة **اتصالات Worktree** في Xuanpu تتيح لك ربط شجرتي عمل معاً، مما يخلق جسراً بين فروع أو ميزات مختلفة. هذا قوي بشكل لا يصدق لسير عمل التطوير الذي يتطلب وعياً عبر الفروع.
...
- ✅ **اقتراحات ذكية** - يقترح Xuanpu أشجار عمل ذات صلة للاتصال بناءً على سير عملك
...
<div align="center">
  <img src="docs/screenshots/hive-full-demo.gif" alt="عرض Xuanpu — تنسيق وكلاء AI عبر المشاريع" width="900" />
</div>
...
<div align="center">
  <br/>
  <img src="docs/screenshots/hive-ss-1.png" alt="Xuanpu — جلسة برمجة بالذكاء الاصطناعي مع أشجار عمل git" width="900" />
  <sub>جلسات برمجة بالذكاء الاصطناعي مع إدارة متكاملة لأشجار عمل git</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-worktree-create.png" alt="إنشاء worktree جديد" width="900" />
  <sub>إنشاء وإدارة أشجار العمل بصرياً</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-file-tree.png" alt="شجرة الملفات مع حالة git" width="900" />
  <sub>مستكشف الملفات مع مؤشرات حالة git الحية</sub>
  <br/><br/>
  <img src="docs/screenshots/xuanpu-themes.png" alt="عرض السمات" width="900" />
...
[![Issues](https://img.shields.io/badge/🐛_المشاكل-أبلغ-red?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/issues)
[![Discussions](https://img.shields.io/badge/💬_النقاشات-انضم-purple?style=for-the-badge)](https://github.com/slicenferqin/xuanpu/discussions)
...
- 🐛 [أبلغ عن الأخطاء](https://github.com/slicenferqin/xuanpu/issues/new?template=bug_report.md) مع خطوات إعادة الإنتاج
- 💡 [اطلب ميزات](https://github.com/slicenferqin/xuanpu/issues/new?template=feature_request.md) تريد رؤيتها
- 💬 [انضم للنقاشات](https://github.com/slicenferqin/xuanpu/discussions) للتواصل مع المجتمع
...
- **نظام إضافات** — وسّع Xuanpu بتكاملات مخصصة
...
هل تريد التأثير في خارطة الطريق؟ [انضم للنقاش](https://github.com/slicenferqin/xuanpu/discussions/categories/ideas) أو [ساهم](CONTRIBUTING.md)!
...
يتضمن Xuanpu طرفية أصلية اختيارية مدعومة بـ `libghostty` من [Ghostty](https://ghostty.org/). هذا مطلوب فقط إذا أردت العمل على ميزة الطرفية المدمجة.
...
إذا لم يكن `libghostty` متاحاً، سيبني Xuanpu ويعمل بشكل طبيعي -- ستكون ميزة طرفية Ghostty معطّلة فقط.
...
يستخدم Xuanpu نموذج العمليات الثلاث في Electron مع وضع الحماية الصارم:
...
نحب المساهمات! Xuanpu مبني بواسطة المطورين، للمطورين، ونرحب بالتحسينات من كل نوع.
...
Xuanpu برنامج مفتوح المصدر مرخص بموجب رخصة MIT. انظر ملف [LICENSE](LICENSE) للتفاصيل الكاملة.
